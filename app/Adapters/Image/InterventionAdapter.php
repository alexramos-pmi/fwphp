...
class InterventionAdapter implements ImageUploadAdapter
{
    ...
    {
        $this->uploadDir = __DIR__ . '/../../../public/' . trim($path, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR;
